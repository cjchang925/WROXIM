...
SelectionStrategy *SelectionStrategies::get(
    const string &selectionStrategyName) {
  SelectionStrategiesMap::iterator it =
      getSelectionStrategiesMap()->find(selectionStrategyName);
