...
SelectionStrategiesRegister Selection_BUFFER_LEVEL::selectionStrategiesRegister(
    "BUFFER_LEVEL", getInstance());
...
int Selection_BUFFER_LEVEL::apply(Router *router, const vector<int> &directions,
  ...
  //        cout << "    -> direction " << directions[i] << ", channel status: "
  //        << tmp << endl;
  //      }
