...
RoutingAlgorithmsRegister Routing_NEGATIVE_FIRST::routingAlgorithmsRegister(
    "NEGATIVE_FIRST", getInstance());
...
vector<int> Routing_NEGATIVE_FIRST::route(Router *router,
