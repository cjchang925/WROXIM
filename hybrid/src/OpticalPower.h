...
class OpticalPower {
    ...
    public:
        ...
        void addNewLaserTime(int w_type, int src_id, int dst_id, int start_time, int end_time);
    ...
    private:
        ...
        static multimap<int, tuple<int,int, vector<laser_time>>> laser_time_unsorted; // <w_type, tuple<src_id, dst_id, vector<start_time, end_time>>>
        static map<int, vector<laser_time>> wavelength_intervals;  //w_type ,laser on/off time
        static map<int, int> wavelength_usage_time; // <w_type, usage_time>
        static vector<tuple<int, int, int, set<int>>> laser_intervals;  // <start_time, end_time, active_W_count, set<active_W_type>>

        static multimap<int, tuple<int, vector<laser_time>>> optical_tx_time_unsorted; // <chiplet_id, tuple<w_type, vector<start_time, end_time>>>
        static multimap<int, tuple<int, vector<laser_time>>> optical_Rx_time_unsorted; // <chiplet_id, tuple<w_type, vector<start_time, end_time>>>
        static map<int, vector<tuple<int, int, int, set<int>>>> optical_tx_intervals;  // <start_time, end_time, active_W_count, set<active_W_type>>
        static map<int, vector<tuple<int, int, int, set<int>>>> optical_Rx_intervals;  // <start_time, end_time, active_W_count, set<active_W_type>>
