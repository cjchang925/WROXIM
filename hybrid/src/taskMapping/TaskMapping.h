...
public:    
  ...
  //added by Xuan
  inline int getLastId(void) {
    return _last_taskid; 
  }
  inline void setLastId(int last_taskid) {
    this->_last_taskid = last_taskid; 
  }
...
private:
  ...
  void addPBlockToTask(int appid, int taskid, int_cycles exectime, int staskid, int payload, int path); 
