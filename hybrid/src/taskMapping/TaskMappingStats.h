...
class tm_peexec_statistics {
 ...
 public:
  tm_peexec_statistics() { _reset(); }
  tm_peexec_statistics<T> operator+(const tm_peexec_statistics<T> &other) {
    tm_peexec_statistics<T> temp;
    temp._stat_cswitching_acum =
        _stat_cswitching_acum + other._stat_cswitching_acum;
    ...
    temp._stat_cswitching_energy_d =
        _stat_cswitching_energy_d + other._stat_cswitching_energy_d;
    temp._stat_tskexec_energy_d =
        _stat_tskexec_energy_d + other._stat_tskexec_energy_d;
    temp._stat_idle_energy_d = _stat_idle_energy_d + other._stat_idle_energy_d;
    temp._stat_total_energy_d =
        _stat_total_energy_d + other._stat_total_energy_d;
  ...
  inline T statGetCSwitchingCycles(void) { return _stat_cswitching_acum; }
  inline void statAddTskExecCycles(T cycles) {
    this->_stat_tskexec_acum += cycles;
  }
  inline T statGetTskExecCycles(void) { return _stat_tskexec_acum; }
  inline void statAddIdleCycles(T cycles) { this->_stat_idle_acum += cycles; }
  inline T statGetIdleCycles(void) { return _stat_idle_acum; }
  inline void statIncFlitsTx(void) { this->_stat_flits_tx++; }
  inline T statGetFlitsTx(void) { return _stat_flits_tx; }
  inline void statIncFlitsRx(void) { this->_stat_flits_rx++; }
  inline T statGetFlitsRx(void) { return _stat_flits_rx; }
  inline void statComputePeTotalCyclesAndEnergy(void) {
    this->_stat_cycles_total =
        _stat_cswitching_acum + _stat_tskexec_acum + _stat_idle_acum;

    _stat_cswitching_energy_d =
        GlobalParams::power_configuration.pePowerConfig.running_mode *
        (_stat_cswitching_acum);
    _stat_tskexec_energy_d =
        GlobalParams::power_configuration.pePowerConfig.running_mode *
        (_stat_tskexec_acum);
    _stat_idle_energy_d =
        GlobalParams::power_configuration.pePowerConfig.idle_mode *
        (_stat_idle_acum);
    _stat_total_energy_d = _stat_cswitching_energy_d + _stat_tskexec_energy_d +
                           _stat_idle_energy_d;
  }
  inline T statGetPeTotalCycles(void) { return _stat_cycles_total; }
  ...
  inline double statGetIdleEnergy_d(void) { return this->_stat_idle_energy_d; }
...
class tm_appexec_statistics {
 ...
 public:
  ...
  inline int statGetExecNumber(void) { return (_stat_exec_number); }
  inline void statSetExecNumber(T _stat_exec_number) {
    this->_stat_exec_number = _stat_exec_number;
  }
  inline double statGetAverage(void) { return (_stat_avg); }
  inline void statSetAverage(T _stat_avg) { this->_stat_avg = _stat_avg; }
  inline T statGetLast(void) { return (_stat_last); }
  inline void statSetLast(T _stat_last) { this->_stat_last = _stat_last; }
  inline T statGetMin(void) { return (_stat_min); }
  inline void statSetMin(T _stat_min) { this->_stat_min = _stat_min; }
  inline T statGetMax(void) { return (_stat_max); }
  inline void statSetMax(T _stat_max) { this->_stat_max = _stat_max; }
  void reset(void) { _reset(); }
  void statAddNewValue(T stat_newvalue) {
    _stat_last = stat_newvalue;
    _stat_exec_number++;
    _stat_avg = ((_stat_avg * (_stat_exec_number - 1)) + stat_newvalue) /
                (_stat_exec_number);
  ...
  void statAddNewValue(tm_appexec_statistics<T> &other) {
    if ((_stat_exec_number + other._stat_exec_number) == 0) {
      ...
      _stat_avg = ((_stat_avg * _stat_exec_number) +
                   (other._stat_avg * other._stat_exec_number)) /
