...
class tm_tx_block {
 ...
 public:
  ...
  inline tm_task *getSrcTask(void) { return _src_task; }
  inline void setSrcTask(tm_task *src_task) { this->_src_task = src_task; }
  inline tm_task *getDstTask(void) { return _dst_task; }
  inline void setDstTask(tm_task *dst_task) { this->_dst_task = dst_task; }
  inline int getPbId(void) { return _pblock_id; }
  inline int getPath(void) { return _pblock_path; }

  inline void setPbId(int pblock_id) { this->_pblock_id = pblock_id; }
  inline void setPath(int pblock_path) { this->_pblock_path = pblock_path; }
  inline int_cycles getStartTxCycle(void) { return _starttx_cycle; }
...
class PEMappedTaskExecution {
 private:
  ...
  queue<tm_tx_block>
      waitingpb_tx; // PBlocks that have payload to be transmitted
  ...
  int_cycles _computeNextTimeToUnmapTask(tm_task *t,
                                         int_cycles _nextTimeToUnmap);
