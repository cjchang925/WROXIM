...
void Power::leakageBufferRouter()
{
    ...
    //cout<<"In Power::leakageBufferRouter(), buffer_router_pwr_s = "<<buffer_router_pwr_s<<endl;
}
...
void Power::leakageLinkRouter2Hub()
{
    ...
    //cout<<"In Power::leakageLinkRouter2Hub(), link_r2h_pwr_s = "<<power_static.breakdown[LINK_R2H_PWR_S].value<<endl;
}
