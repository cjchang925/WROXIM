...
for mapfile in "Robot_mesh_4x4_stp" "Fpppp_mesh_4x4_stp"; do
    ...
    for ARCH in "LAMBDA" "GWOR"; do
        for network_protocol in "ABP" "ON_OFF_FLOWCONTROL"; do
            ...
            ./noxim -config ../tm_examples/01-16-nownoc.yaml \
                ...
                -taskmappinglog ../tm_log/${mapfile}/${ARCH}/${ARCH}_${network_protocol}_b${buffer_depth}.log > ../tm_log/tmp_output2.log
        done
    done
done
