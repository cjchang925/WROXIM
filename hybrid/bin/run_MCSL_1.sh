...
for mapfile in "FFT-1024_complex_mesh_4x4_stp" "Sparse_mesh_4x4_stp" "Robot_mesh_4x4_stp" "Fpppp_mesh_4x4_stp" "RS-32_28_8_dec_mesh_4x4_stp"; do
    ...
    echo "Running ${mapfile}.map with buffer_depth=${buffer_depth} in MESH architecture (sim=${sim_time})..."
    ...
    ./noxim -config ../tm_examples/01-16-nownoc.yaml \
            ...
            -taskmappinglog ../tm_log/${mapfile}/MESH/MESH_b${buffer_depth}.log > ../tm_log/tmp_output1.log
